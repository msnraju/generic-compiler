...
import { IASTNode, IASTTransformer, IASTVisitor } from "../ast-models";
import { IGrammar } from "../grammar-modals";
...
//const parseTree2 = Parser.parse('PLUS FACTOR | MINUS FACTOR | INTEGER | LPAREN EXPR RPAREN | MEMBER_EXPRESSION | VARIABLE');
//const syntaxTree = Transformer.transform(parseTree2, {value: 0});
